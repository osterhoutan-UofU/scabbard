; ModuleID = 'test/hello.cpp'
source_filename = "test/hello.cpp"
...
define dso_local i32 @main() local_unnamed_addr #3 {
  %1 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* nonnull dereferenceable(272) @_ZSt4cout, i8* nonnull getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i64 11)
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_hello.cpp() #4 section ".text.startup" {
