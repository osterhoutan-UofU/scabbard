...
define protected amdgpu_kernel void @_Z15tick_all_kernelPU7_AtomicmPmPl(i64 addrspace(1)* nocapture %0, i64 addrspace(1)* nocapture writeonly %1, i64 addrspace(1)* nocapture %2) local_unnamed_addr #0 !dbg !1763 {
  %4 = addrspacecast i64 addrspace(1)* %2 to i64*
  tail call fastcc void @_Z10dummy_workPl(i64* %4) #6, !dbg !1774
  %5 = atomicrmw add i64 addrspace(1)* %0, i64 1 seq_cst, align 8, !dbg !1775
  %6 = add i64 %5, 1, !dbg !1775
  %7 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1776, !range !1790
  %8 = zext i32 %7 to i64, !dbg !1791
  %9 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %8, !dbg !1791
  store i64 %6, i64 addrspace(1)* %9, align 8, !dbg !1792, !tbaa !1793
  fence syncscope("workgroup") release, !dbg !1797
  tail call void @llvm.amdgcn.s.barrier(), !dbg !1816
  fence syncscope("workgroup") acquire, !dbg !1817
  tail call fastcc void @_Z10dummy_workPl(i64* %4) #6, !dbg !1818
  ret void, !dbg !1819
}

; Function Attrs: argmemonly mustprogress nofree noinline norecurse nosync nounwind willreturn
define internal fastcc void @_Z10dummy_workPl(i64* nocapture %0) unnamed_addr #1 !dbg !1820 {
  %2 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1826, !range !1790
  %3 = zext i32 %2 to i64, !dbg !1826
  %4 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr(), !dbg !1827
  %5 = getelementptr inbounds i8, i8 addrspace(4)* %4, i64 12, !dbg !1827
  %6 = bitcast i8 addrspace(4)* %5 to i32 addrspace(4)*, !dbg !1827
  %7 = load i32, i32 addrspace(4)* %6, align 4, !dbg !1827, !tbaa !1828
  %8 = tail call i32 @llvm.amdgcn.workgroup.id.x(), !dbg !1827
  %9 = getelementptr i8, i8 addrspace(4)* %4, i64 4, !dbg !1827
  %10 = bitcast i8 addrspace(4)* %9 to i16 addrspace(4)*, !dbg !1827
  %11 = load i16, i16 addrspace(4)* %10, align 4, !dbg !1827, !range !1837, !invariant.load !1814
  %12 = zext i16 %11 to i32, !dbg !1827
  %13 = mul i32 %8, %12, !dbg !1827
  %14 = sub i32 %7, %13, !dbg !1827
  %15 = tail call i32 @llvm.umin.i32(i32 %14, i32 %12), !dbg !1827
  %16 = zext i32 %15 to i64, !dbg !1827
  %17 = zext i32 %8 to i64, !dbg !1838
  %18 = mul nuw nsw i64 %16, %17, !dbg !1839
  %19 = add nuw nsw i64 %18, %3, !dbg !1840
  %20 = shl i64 %19, 32, !dbg !1841
  %21 = ashr exact i64 %20, 32, !dbg !1841
  %22 = getelementptr inbounds i64, i64* %0, i64 %21, !dbg !1842
  %23 = load i64, i64* %22, align 8, !dbg !1843, !tbaa !1793
  %24 = add nsw i64 %21, %23, !dbg !1843
  store i64 %24, i64* %22, align 8, !dbg !1843, !tbaa !1793
  ret void, !dbg !1844
}

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z10dummy_initPl(i64 addrspace(1)* nocapture writeonly %0) local_unnamed_addr #2 !dbg !1845 {
  %2 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1849, !range !1790
  %3 = zext i32 %2 to i64, !dbg !1849
  %4 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr(), !dbg !1850
  %5 = tail call i32 @llvm.amdgcn.workgroup.id.x(), !dbg !1850
  %6 = getelementptr i8, i8 addrspace(4)* %4, i64 4, !dbg !1850
  %7 = bitcast i8 addrspace(4)* %6 to i16 addrspace(4)*, !dbg !1850
  %8 = load i16, i16 addrspace(4)* %7, align 4, !dbg !1850, !range !1837, !invariant.load !1814
  %9 = zext i16 %8 to i64, !dbg !1850
  %10 = zext i32 %5 to i64, !dbg !1851
  %11 = mul nuw nsw i64 %9, %10, !dbg !1852
  %12 = add nuw nsw i64 %11, %3, !dbg !1853
  %13 = shl i64 %12, 32, !dbg !1854
  %14 = ashr exact i64 %13, 32, !dbg !1854
  %15 = getelementptr inbounds i64, i64 addrspace(1)* %0, i64 %14, !dbg !1854
  store i64 0, i64 addrspace(1)* %15, align 8, !dbg !1855, !tbaa !1793
  ret void, !dbg !1856
}
...
!1 = !DIFile(filename: "test/managed_clock_test.cpp", directory: "/g/g11/osterhou/repos/scabbard", checksumkind: CSK_MD5, checksum: "c4677b4754bc5f34947825e13443d0e3")
!2 = !{!3, !11, !19}
...
!1763 = distinct !DISubprogram(name: "tick_all_kernel", linkageName: "_Z15tick_all_kernelPU7_AtomicmPmPl", scope: !1, file: !1, line: 57, type: !1764, scopeLine: 58, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1770)
!1764 = !DISubroutineType(types: !1765)
!1765 = !{null, !1766, !1768, !1769}
...
!1774 = !DILocation(line: 59, column: 3, scope: !1763)
!1775 = !DILocation(line: 60, column: 29, scope: !1763)
!1776 = !DILocation(line: 280, column: 12, scope: !1777, inlinedAt: !1783)
!1777 = distinct !DISubprogram(name: "operator()", linkageName: "_ZNK15__HIP_ThreadIdxclEj", scope: !1746, file: !1714, line: 279, type: !1778, scopeLine: 279, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1748, retainedNodes: !1779)
!1778 = !DISubroutineType(cc: DW_CC_nocall, types: !1750)
!1779 = !{!1780, !1782}
!1780 = !DILocalVariable(name: "this", arg: 1, scope: !1777, type: !1781, flags: DIFlagArtificial | DIFlagObjectPointer)
!1781 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1752, size: 64)
!1782 = !DILocalVariable(name: "x", arg: 2, scope: !1777, file: !1714, line: 279, type: !32)
!1783 = distinct !DILocation(line: 300, column: 53, scope: !1784, inlinedAt: !1789)
!1784 = distinct !DISubprogram(name: "operator unsigned int", linkageName: "_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE3__XcvjEv", scope: !1720, file: !1714, line: 300, type: !1785, scopeLine: 300, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1722, retainedNodes: !1786)
!1785 = !DISubroutineType(cc: DW_CC_nocall, types: !1724)
!1786 = !{!1787}
!1787 = !DILocalVariable(name: "this", arg: 1, scope: !1784, type: !1788, flags: DIFlagArtificial | DIFlagObjectPointer)
!1788 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1719, size: 64)
!1789 = distinct !DILocation(line: 60, column: 8, scope: !1763)
!1790 = !{i32 0, i32 1024}
!1791 = !DILocation(line: 60, column: 3, scope: !1763)
!1792 = !DILocation(line: 60, column: 21, scope: !1763)
!1793 = !{!1794, !1794, i64 0}
!1794 = !{!"long", !1795, i64 0}
!1795 = !{!"omnipotent char", !1796, i64 0}
!1796 = !{!"Simple C++ TBAA"}
!1797 = !DILocation(line: 924, column: 9, scope: !1798, inlinedAt: !1807)
!1798 = distinct !DILexicalBlock(scope: !1799, file: !1651, line: 923, column: 16)
!1799 = distinct !DILexicalBlock(scope: !1800, file: !1651, line: 923, column: 9)
!1800 = distinct !DISubprogram(name: "__work_group_barrier", linkageName: "_ZL20__work_group_barrierj14__memory_scope", scope: !1651, file: !1651, line: 921, type: !1801, scopeLine: 922, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1804)
!1801 = !DISubroutineType(cc: DW_CC_nocall, types: !1802)
!1802 = !{null, !27, !1803}
!1803 = !DIDerivedType(tag: DW_TAG_typedef, name: "__memory_scope", file: !12, line: 137, baseType: !11)
!1804 = !{!1805, !1806}
!1805 = !DILocalVariable(name: "flags", arg: 1, scope: !1800, file: !1651, line: 921, type: !27)
!1806 = !DILocalVariable(name: "scope", arg: 2, scope: !1800, file: !1651, line: 921, type: !1803)
!1807 = distinct !DILocation(line: 936, column: 3, scope: !1808, inlinedAt: !1812)
!1808 = distinct !DISubprogram(name: "__barrier", linkageName: "_ZL9__barrieri", scope: !1651, file: !1651, line: 934, type: !1809, scopeLine: 935, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1810)
!1809 = !DISubroutineType(cc: DW_CC_nocall, types: !454)
!1810 = !{!1811}
!1811 = !DILocalVariable(name: "n", arg: 1, scope: !1808, file: !1651, line: 934, type: !49)
!1812 = distinct !DILocation(line: 944, column: 3, scope: !1813, inlinedAt: !1815)
!1813 = distinct !DISubprogram(name: "__syncthreads", linkageName: "_Z13__syncthreadsv", scope: !1651, file: !1651, line: 942, type: !406, scopeLine: 943, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1814)
!1814 = !{}
!1815 = distinct !DILocation(line: 61, column: 3, scope: !1763)
!1816 = !DILocation(line: 925, column: 9, scope: !1798, inlinedAt: !1807)
!1817 = !DILocation(line: 926, column: 9, scope: !1798, inlinedAt: !1807)
!1818 = !DILocation(line: 62, column: 3, scope: !1763)
!1819 = !DILocation(line: 63, column: 1, scope: !1763)
!1820 = distinct !DISubprogram(name: "dummy_work", linkageName: "_Z10dummy_workPl", scope: !1, file: !1, line: 189, type: !1821, scopeLine: 190, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1823)
!1821 = !DISubroutineType(types: !1822)
!1822 = !{null, !1769}
!1823 = !{!1824, !1825}
!1824 = !DILocalVariable(name: "dummy_data", arg: 1, scope: !1820, file: !1, line: 189, type: !1769)
!1825 = !DILocalVariable(name: "i", scope: !1820, file: !1, line: 191, type: !49)
!1826 = !DILocation(line: 191, column: 11, scope: !1820)
!1827 = !DILocation(line: 191, column: 28, scope: !1820)
!1828 = !{!1829, !1833, i64 12}
!1829 = !{!"hsa_kernel_dispatch_packet_s", !1830, i64 0, !1830, i64 2, !1830, i64 4, !1830, i64 6, !1830, i64 8, !1830, i64 10, !1833, i64 12, !1833, i64 16, !1833, i64 20, !1833, i64 24, !1833, i64 28, !1834, i64 32, !1835, i64 40, !1834, i64 48, !1836, i64 56}
!1830 = !{!"short", !1831, i64 0}
!1831 = !{!"omnipotent char", !1832, i64 0}
!1832 = !{!"Simple C/C++ TBAA"}
!1833 = !{!"int", !1831, i64 0}
!1834 = !{!"long", !1831, i64 0}
!1835 = !{!"any pointer", !1831, i64 0}
!1836 = !{!"hsa_signal_s", !1834, i64 0}
!1837 = !{i16 1, i16 1025}
!1838 = !DILocation(line: 191, column: 44, scope: !1820)
!1839 = !DILocation(line: 191, column: 42, scope: !1820)
!1840 = !DILocation(line: 191, column: 26, scope: !1820)
!1841 = !DILocation(line: 192, column: 20, scope: !1820)
!1842 = !DILocation(line: 192, column: 3, scope: !1820)
!1843 = !DILocation(line: 192, column: 17, scope: !1820)
!1844 = !DILocation(line: 193, column: 1, scope: !1820)
!1845 = distinct !DISubprogram(name: "dummy_init", linkageName: "_Z10dummy_initPl", scope: !1, file: !1, line: 182, type: !1821, scopeLine: 183, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1846)
!1846 = !{!1847, !1848}
!1847 = !DILocalVariable(name: "dummy_data", arg: 1, scope: !1845, file: !1, line: 182, type: !1769)
!1848 = !DILocalVariable(name: "i", scope: !1845, file: !1, line: 184, type: !49)
!1849 = !DILocation(line: 184, column: 11, scope: !1845)
!1850 = !DILocation(line: 184, column: 28, scope: !1845)
!1851 = !DILocation(line: 184, column: 44, scope: !1845)
!1852 = !DILocation(line: 184, column: 42, scope: !1845)
!1853 = !DILocation(line: 184, column: 26, scope: !1845)
!1854 = !DILocation(line: 185, column: 3, scope: !1845)
!1855 = !DILocation(line: 185, column: 17, scope: !1845)
!1856 = !DILocation(line: 186, column: 1, scope: !1845)
...
!9 = !DIFile(filename: "test/managed_clock_test.cpp", directory: "/g/g11/osterhou/repos/scabbard", checksumkind: CSK_MD5, checksum: "c4677b4754bc5f34947825e13443d0e3")
