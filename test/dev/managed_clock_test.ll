...
define protected amdgpu_kernel void @_Z15tick_all_kernelPU7_AtomicmPmPli(i64 addrspace(1)* nocapture %0, i64 addrspace(1)* nocapture writeonly %1, i64 addrspace(1)* nocapture %2, i32 %3) local_unnamed_addr #0 !dbg !1763 {
  %5 = addrspacecast i64 addrspace(1)* %2 to i64*
  tail call fastcc void @_Z10dummy_workPl(i64* %5) #6, !dbg !1775
  %6 = atomicrmw add i64 addrspace(1)* %0, i64 1 seq_cst, align 8, !dbg !1776
  %7 = add i64 %6, 1, !dbg !1776
  %8 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1777, !range !1791
  %9 = add i32 %8, %3, !dbg !1792
  %10 = zext i32 %9 to i64, !dbg !1793
  %11 = getelementptr inbounds i64, i64 addrspace(1)* %1, i64 %10, !dbg !1793
  store i64 %7, i64 addrspace(1)* %11, align 8, !dbg !1794, !tbaa !1795
  fence syncscope("workgroup") release, !dbg !1799
  tail call void @llvm.amdgcn.s.barrier(), !dbg !1818
  fence syncscope("workgroup") acquire, !dbg !1819
  tail call fastcc void @_Z10dummy_workPl(i64* %5) #6, !dbg !1820
  ret void, !dbg !1821
}

; Function Attrs: argmemonly mustprogress nofree noinline norecurse nosync nounwind willreturn
define internal fastcc void @_Z10dummy_workPl(i64* nocapture %0) unnamed_addr #1 !dbg !1822 {
  %2 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1828, !range !1791
  %3 = zext i32 %2 to i64, !dbg !1828
  %4 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr(), !dbg !1829
  %5 = getelementptr inbounds i8, i8 addrspace(4)* %4, i64 12, !dbg !1829
  %6 = bitcast i8 addrspace(4)* %5 to i32 addrspace(4)*, !dbg !1829
  %7 = load i32, i32 addrspace(4)* %6, align 4, !dbg !1829, !tbaa !1830
  %8 = tail call i32 @llvm.amdgcn.workgroup.id.x(), !dbg !1829
  %9 = getelementptr i8, i8 addrspace(4)* %4, i64 4, !dbg !1829
  %10 = bitcast i8 addrspace(4)* %9 to i16 addrspace(4)*, !dbg !1829
  %11 = load i16, i16 addrspace(4)* %10, align 4, !dbg !1829, !range !1839, !invariant.load !1816
  %12 = zext i16 %11 to i32, !dbg !1829
  %13 = mul i32 %8, %12, !dbg !1829
  %14 = sub i32 %7, %13, !dbg !1829
  %15 = tail call i32 @llvm.umin.i32(i32 %14, i32 %12), !dbg !1829
  %16 = zext i32 %15 to i64, !dbg !1829
  %17 = zext i32 %8 to i64, !dbg !1840
  %18 = mul nuw nsw i64 %16, %17, !dbg !1841
  %19 = add nuw nsw i64 %18, %3, !dbg !1842
  %20 = shl i64 %19, 32, !dbg !1843
  %21 = ashr exact i64 %20, 32, !dbg !1843
  %22 = getelementptr inbounds i64, i64* %0, i64 %21, !dbg !1844
  %23 = load i64, i64* %22, align 8, !dbg !1845, !tbaa !1795
  %24 = add nsw i64 %21, %23, !dbg !1845
  store i64 %24, i64* %22, align 8, !dbg !1845, !tbaa !1795
  ret void, !dbg !1846
}

; Function Attrs: convergent mustprogress norecurse nounwind willreturn
define protected amdgpu_kernel void @_Z12dummy_kernelv() local_unnamed_addr #0 !dbg !1847 {
  fence syncscope("workgroup") release, !dbg !1848
  tail call void @llvm.amdgcn.s.barrier(), !dbg !1852
  fence syncscope("workgroup") acquire, !dbg !1853
  ret void, !dbg !1854
}

; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind willreturn writeonly
define protected amdgpu_kernel void @_Z10dummy_initPl(i64 addrspace(1)* nocapture writeonly %0) local_unnamed_addr #2 !dbg !1855 {
  %2 = tail call i32 @llvm.amdgcn.workitem.id.x(), !dbg !1859, !range !1791
  %3 = zext i32 %2 to i64, !dbg !1859
  %4 = tail call align 4 dereferenceable(64) i8 addrspace(4)* @llvm.amdgcn.dispatch.ptr(), !dbg !1860
  %5 = tail call i32 @llvm.amdgcn.workgroup.id.x(), !dbg !1860
  %6 = getelementptr i8, i8 addrspace(4)* %4, i64 4, !dbg !1860
  %7 = bitcast i8 addrspace(4)* %6 to i16 addrspace(4)*, !dbg !1860
  %8 = load i16, i16 addrspace(4)* %7, align 4, !dbg !1860, !range !1839, !invariant.load !1816
  %9 = zext i16 %8 to i64, !dbg !1860
  %10 = zext i32 %5 to i64, !dbg !1861
  %11 = mul nuw nsw i64 %9, %10, !dbg !1862
  %12 = add nuw nsw i64 %11, %3, !dbg !1863
  %13 = shl i64 %12, 32, !dbg !1864
  %14 = ashr exact i64 %13, 32, !dbg !1864
  %15 = getelementptr inbounds i64, i64 addrspace(1)* %0, i64 %14, !dbg !1864
  store i64 0, i64 addrspace(1)* %15, align 8, !dbg !1865, !tbaa !1795
  ret void, !dbg !1866
}
...
!1775 = !DILocation(line: 59, column: 3, scope: !1763)
!1776 = !DILocation(line: 60, column: 34, scope: !1763)
!1777 = !DILocation(line: 280, column: 12, scope: !1778, inlinedAt: !1784)
!1778 = distinct !DISubprogram(name: "operator()", linkageName: "_ZNK15__HIP_ThreadIdxclEj", scope: !1746, file: !1714, line: 279, type: !1779, scopeLine: 279, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1748, retainedNodes: !1780)
!1779 = !DISubroutineType(cc: DW_CC_nocall, types: !1750)
!1780 = !{!1781, !1783}
!1781 = !DILocalVariable(name: "this", arg: 1, scope: !1778, type: !1782, flags: DIFlagArtificial | DIFlagObjectPointer)
!1782 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1752, size: 64)
!1783 = !DILocalVariable(name: "x", arg: 2, scope: !1778, file: !1714, line: 279, type: !32)
!1784 = distinct !DILocation(line: 300, column: 53, scope: !1785, inlinedAt: !1790)
!1785 = distinct !DISubprogram(name: "operator unsigned int", linkageName: "_ZNK17__HIP_CoordinatesI15__HIP_ThreadIdxE3__XcvjEv", scope: !1720, file: !1714, line: 300, type: !1786, scopeLine: 300, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1722, retainedNodes: !1787)
!1786 = !DISubroutineType(cc: DW_CC_nocall, types: !1724)
!1787 = !{!1788}
!1788 = !DILocalVariable(name: "this", arg: 1, scope: !1785, type: !1789, flags: DIFlagArtificial | DIFlagObjectPointer)
!1789 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1719, size: 64)
!1790 = distinct !DILocation(line: 60, column: 8, scope: !1763)
!1791 = !{i32 0, i32 1024}
!1792 = !DILocation(line: 60, column: 19, scope: !1763)
!1793 = !DILocation(line: 60, column: 3, scope: !1763)
!1794 = !DILocation(line: 60, column: 26, scope: !1763)
!1795 = !{!1796, !1796, i64 0}
!1796 = !{!"long", !1797, i64 0}
!1797 = !{!"omnipotent char", !1798, i64 0}
!1798 = !{!"Simple C++ TBAA"}
!1799 = !DILocation(line: 924, column: 9, scope: !1800, inlinedAt: !1809)
!1800 = distinct !DILexicalBlock(scope: !1801, file: !1651, line: 923, column: 16)
!1801 = distinct !DILexicalBlock(scope: !1802, file: !1651, line: 923, column: 9)
!1802 = distinct !DISubprogram(name: "__work_group_barrier", linkageName: "_ZL20__work_group_barrierj14__memory_scope", scope: !1651, file: !1651, line: 921, type: !1803, scopeLine: 922, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1806)
!1803 = !DISubroutineType(cc: DW_CC_nocall, types: !1804)
!1804 = !{null, !27, !1805}
!1805 = !DIDerivedType(tag: DW_TAG_typedef, name: "__memory_scope", file: !12, line: 137, baseType: !11)
!1806 = !{!1807, !1808}
!1807 = !DILocalVariable(name: "flags", arg: 1, scope: !1802, file: !1651, line: 921, type: !27)
!1808 = !DILocalVariable(name: "scope", arg: 2, scope: !1802, file: !1651, line: 921, type: !1805)
!1809 = distinct !DILocation(line: 936, column: 3, scope: !1810, inlinedAt: !1814)
!1810 = distinct !DISubprogram(name: "__barrier", linkageName: "_ZL9__barrieri", scope: !1651, file: !1651, line: 934, type: !1811, scopeLine: 935, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1812)
!1811 = !DISubroutineType(cc: DW_CC_nocall, types: !454)
!1812 = !{!1813}
!1813 = !DILocalVariable(name: "n", arg: 1, scope: !1810, file: !1651, line: 934, type: !49)
!1814 = distinct !DILocation(line: 944, column: 3, scope: !1815, inlinedAt: !1817)
!1815 = distinct !DISubprogram(name: "__syncthreads", linkageName: "_Z13__syncthreadsv", scope: !1651, file: !1651, line: 942, type: !406, scopeLine: 943, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1816)
!1816 = !{}
!1817 = distinct !DILocation(line: 61, column: 3, scope: !1763)
!1818 = !DILocation(line: 925, column: 9, scope: !1800, inlinedAt: !1809)
!1819 = !DILocation(line: 926, column: 9, scope: !1800, inlinedAt: !1809)
!1820 = !DILocation(line: 62, column: 3, scope: !1763)
!1821 = !DILocation(line: 63, column: 1, scope: !1763)
!1822 = distinct !DISubprogram(name: "dummy_work", linkageName: "_Z10dummy_workPl", scope: !1, file: !1, line: 195, type: !1823, scopeLine: 196, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1825)
!1823 = !DISubroutineType(types: !1824)
!1824 = !{null, !1769}
!1825 = !{!1826, !1827}
!1826 = !DILocalVariable(name: "dummy_data", arg: 1, scope: !1822, file: !1, line: 195, type: !1769)
!1827 = !DILocalVariable(name: "i", scope: !1822, file: !1, line: 197, type: !49)
!1828 = !DILocation(line: 197, column: 11, scope: !1822)
!1829 = !DILocation(line: 197, column: 28, scope: !1822)
!1830 = !{!1831, !1835, i64 12}
!1831 = !{!"hsa_kernel_dispatch_packet_s", !1832, i64 0, !1832, i64 2, !1832, i64 4, !1832, i64 6, !1832, i64 8, !1832, i64 10, !1835, i64 12, !1835, i64 16, !1835, i64 20, !1835, i64 24, !1835, i64 28, !1836, i64 32, !1837, i64 40, !1836, i64 48, !1838, i64 56}
!1832 = !{!"short", !1833, i64 0}
!1833 = !{!"omnipotent char", !1834, i64 0}
!1834 = !{!"Simple C/C++ TBAA"}
!1835 = !{!"int", !1833, i64 0}
!1836 = !{!"long", !1833, i64 0}
!1837 = !{!"any pointer", !1833, i64 0}
!1838 = !{!"hsa_signal_s", !1836, i64 0}
!1839 = !{i16 1, i16 1025}
!1840 = !DILocation(line: 197, column: 44, scope: !1822)
!1841 = !DILocation(line: 197, column: 42, scope: !1822)
!1842 = !DILocation(line: 197, column: 26, scope: !1822)
!1843 = !DILocation(line: 198, column: 20, scope: !1822)
!1844 = !DILocation(line: 198, column: 3, scope: !1822)
!1845 = !DILocation(line: 198, column: 17, scope: !1822)
!1846 = !DILocation(line: 199, column: 1, scope: !1822)
!1847 = distinct !DISubprogram(name: "dummy_kernel", linkageName: "_Z12dummy_kernelv", scope: !1, file: !1, line: 155, type: !406, scopeLine: 156, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1816)
!1848 = !DILocation(line: 924, column: 9, scope: !1800, inlinedAt: !1849)
!1849 = distinct !DILocation(line: 936, column: 3, scope: !1810, inlinedAt: !1850)
!1850 = distinct !DILocation(line: 944, column: 3, scope: !1815, inlinedAt: !1851)
!1851 = distinct !DILocation(line: 157, column: 3, scope: !1847)
!1852 = !DILocation(line: 925, column: 9, scope: !1800, inlinedAt: !1849)
!1853 = !DILocation(line: 926, column: 9, scope: !1800, inlinedAt: !1849)
!1854 = !DILocation(line: 158, column: 1, scope: !1847)
!1855 = distinct !DISubprogram(name: "dummy_init", linkageName: "_Z10dummy_initPl", scope: !1, file: !1, line: 188, type: !1823, scopeLine: 189, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !1856)
!1856 = !{!1857, !1858}
!1857 = !DILocalVariable(name: "dummy_data", arg: 1, scope: !1855, file: !1, line: 188, type: !1769)
!1858 = !DILocalVariable(name: "i", scope: !1855, file: !1, line: 190, type: !49)
!1859 = !DILocation(line: 190, column: 11, scope: !1855)
!1860 = !DILocation(line: 190, column: 28, scope: !1855)
!1861 = !DILocation(line: 190, column: 44, scope: !1855)
!1862 = !DILocation(line: 190, column: 42, scope: !1855)
!1863 = !DILocation(line: 190, column: 26, scope: !1855)
!1864 = !DILocation(line: 191, column: 3, scope: !1855)
!1865 = !DILocation(line: 191, column: 17, scope: !1855)
!1866 = !DILocation(line: 192, column: 1, scope: !1855)
...
@llvm.global_ctors = appending global [2 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_managed_clock_test.cpp, i8* null }, { i32, void ()*, i8* } { i32 65535, void ()* @__hip_module_ctor, i8* null }]
...
define dso_local void @_Z30__device_stub__tick_all_kernelPU7_AtomicmPmPli(i64* noundef %0, i64* noundef %1, i64* noundef %2, i32 noundef %3) #3 {
  ...
  %34 = call noundef i32 @hipLaunchKernel(i8* noundef bitcast (void (i64*, i64*, i64*, i32)** @_Z15tick_all_kernelPU7_AtomicmPmPli to i8*), i64 %27, i32 %29, i64 %31, i32 %33, i8** noundef nonnull %14, i64 noundef %23, %struct.ihipStream_t* noundef %25)
  ret void
}
...
define dso_local void @_Z13tick_all_testi(i32 noundef %0) local_unnamed_addr #4 personality i32 (...)* @__gxx_personality_v0 !dbg !2223 {
  ...
  %23 = bitcast i32* %19 to i8*, !dbg !2247
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %23) #18, !dbg !2247
  call void @llvm.dbg.value(metadata i32 0, metadata !2226, metadata !DIExpression()), !dbg !2246
  store i32 0, i32* %19, align 4, !dbg !2248, !tbaa !2221
  call void @llvm.dbg.value(metadata i32* %19, metadata !2226, metadata !DIExpression(DW_OP_deref)), !dbg !2246
  %24 = call i32 @hipGetDevice(i32* noundef nonnull %19), !dbg !2249
  call void @llvm.dbg.value(metadata i32 %24, metadata !2250, metadata !DIExpression()), !dbg !2256
  %25 = icmp eq i32 %24, 0, !dbg !2258
  br i1 %25, label %30, label %26, !dbg !2260

26:                                               ; preds = %1
  %27 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2261
  %28 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %27, i32 noundef %24), !dbg !2263
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %28, metadata !2264, metadata !DIExpression()), !dbg !2281
  ...
  %29 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %28), !dbg !2283
...
30:                                               ; preds = %1
  ...
  %32 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout), !dbg !2361
  ...
  %34 = load i32, i32* %19, align 4, !dbg !2365, !tbaa !2221
  call void @llvm.dbg.value(metadata i32 %34, metadata !2226, metadata !DIExpression()), !dbg !2246
  %35 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %34), !dbg !2366
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %35, metadata !2264, metadata !DIExpression()), !dbg !2367
  ...
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %35, metadata !2369, metadata !DIExpression()), !dbg !2372
  %36 = bitcast %"class.std::basic_ostream"* %35 to i8**, !dbg !2374
  %37 = load i8*, i8** %36, align 8, !dbg !2374, !tbaa !2375
  %38 = getelementptr i8, i8* %37, i64 -24, !dbg !2374
  %39 = bitcast i8* %38 to i64*, !dbg !2374
  %40 = load i64, i64* %39, align 8, !dbg !2374
  %41 = bitcast %"class.std::basic_ostream"* %35 to i8*, !dbg !2374
  %42 = getelementptr inbounds i8, i8* %41, i64 %40, !dbg !2374
  call void @llvm.dbg.value(metadata i8* %42, metadata !2377, metadata !DIExpression()), !dbg !2391
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !2391
  %43 = getelementptr inbounds i8, i8* %42, i64 240, !dbg !2393
  %44 = bitcast i8* %43 to %"class.std::ctype"**, !dbg !2393
  %45 = load %"class.std::ctype"*, %"class.std::ctype"** %44, align 8, !dbg !2393, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %45, metadata !2403, metadata !DIExpression()), !dbg !2415
  %46 = icmp eq %"class.std::ctype"* %45, null, !dbg !2417
  br i1 %46, label %47, label %48, !dbg !2419
...
48:                                               ; preds = %30
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %45, metadata !2421, metadata !DIExpression()), !dbg !2430
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !2430
  %49 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %45, i64 0, i32 8, !dbg !2432
  %50 = load i8, i8* %49, align 8, !dbg !2432, !tbaa !2434
  %51 = icmp eq i8 %50, 0, !dbg !2432
  br i1 %51, label %55, label %52, !dbg !2437

52:                                               ; preds = %48
  %53 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %45, i64 0, i32 9, i64 10, !dbg !2438
  %54 = load i8, i8* %53, align 1, !dbg !2438, !tbaa !2439
  br label %61, !dbg !2440

55:                                               ; preds = %48
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %45), !dbg !2441
  %56 = bitcast %"class.std::ctype"* %45 to i8 (%"class.std::ctype"*, i8)***, !dbg !2442
  %57 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %56, align 8, !dbg !2442, !tbaa !2375
  %58 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %57, i64 6, !dbg !2442
  %59 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %58, align 8, !dbg !2442
  %60 = call noundef signext i8 %59(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %45, i8 noundef signext 10), !dbg !2442
  br label %61, !dbg !2443

61:                                               ; preds = %52, %55
  %62 = phi i8 [ %54, %52 ], [ %60, %55 ], !dbg !2430
  %63 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %35, i8 noundef signext %62), !dbg !2444
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %63, metadata !2353, metadata !DIExpression()), !dbg !2445
  %64 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %63), !dbg !2447
  ...
  %65 = bitcast i64** %20 to i8*, !dbg !2448
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %65) #18, !dbg !2448
  call void @llvm.dbg.value(metadata i64** %20, metadata !2233, metadata !DIExpression(DW_OP_deref)), !dbg !2246
  call void @llvm.dbg.value(metadata i64** %20, metadata !2449, metadata !DIExpression()), !dbg !2461
  ...
  %66 = bitcast i64** %20 to i8**, !dbg !2463
  %67 = call i32 @hipMallocManaged(i8** noundef nonnull %66, i64 noundef 1, i32 noundef 1), !dbg !2464
  call void @llvm.dbg.value(metadata i32 %67, metadata !2250, metadata !DIExpression()), !dbg !2465
  %68 = icmp eq i32 %67, 0, !dbg !2467
  br i1 %68, label %73, label %69, !dbg !2468

69:                                               ; preds = %61
  %70 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2469
  %71 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %70, i32 noundef %67), !dbg !2470
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %71, metadata !2264, metadata !DIExpression()), !dbg !2471
  ...
  %72 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %71), !dbg !2473
  call void @exit(i32 noundef 1) #19, !dbg !2474
  unreachable, !dbg !2474

73:                                               ; preds = %61
  %74 = load i64*, i64** %20, align 8, !dbg !2475, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %74, metadata !2233, metadata !DIExpression()), !dbg !2246
  store atomic i64 0, i64* %74 seq_cst, align 8, !dbg !2476, !tbaa !2439
  %75 = call noalias noundef nonnull dereferenceable(8192) i8* @_Znam(i64 noundef 8192) #21, !dbg !2477, !heapallocsite !1681
  %76 = bitcast i8* %75 to i64*, !dbg !2477
  call void @llvm.dbg.value(metadata i64* %76, metadata !2236, metadata !DIExpression()), !dbg !2246
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(8192) %75, i8 0, i64 8192, i1 false), !dbg !2478
  %77 = bitcast i64** %21 to i8*, !dbg !2479
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %77) #18, !dbg !2479
  call void @llvm.dbg.value(metadata i64** %21, metadata !2238, metadata !DIExpression(DW_OP_deref)), !dbg !2246
  call void @llvm.dbg.value(metadata i64** %21, metadata !2480, metadata !DIExpression()), !dbg !2490
  call void @llvm.dbg.value(metadata i64 8192, metadata !2487, metadata !DIExpression()), !dbg !2490
  %78 = bitcast i64** %21 to i8**, !dbg !2492
  %79 = call i32 @hipMalloc(i8** noundef nonnull %78, i64 noundef 8192), !dbg !2493
  call void @llvm.dbg.value(metadata i32 %79, metadata !2250, metadata !DIExpression()), !dbg !2494
  %80 = icmp eq i32 %79, 0, !dbg !2496
  br i1 %80, label %85, label %81, !dbg !2497

81:                                               ; preds = %73
  %82 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2498
  %83 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %82, i32 noundef %79), !dbg !2499
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %83, metadata !2264, metadata !DIExpression()), !dbg !2500
  ...
  %84 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %83), !dbg !2502
  call void @exit(i32 noundef 1) #19, !dbg !2503
  unreachable, !dbg !2503

85:                                               ; preds = %73
  %86 = load i8*, i8** %78, align 8, !dbg !2504, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2238, metadata !DIExpression()), !dbg !2246
  %87 = call i32 @hipMemcpy(i8* noundef %86, i8* noundef nonnull %75, i64 noundef 8192, i32 noundef 1), !dbg !2505
  call void @llvm.dbg.value(metadata i32 %87, metadata !2250, metadata !DIExpression()), !dbg !2506
  %88 = icmp eq i32 %87, 0, !dbg !2508
  br i1 %88, label %93, label %89, !dbg !2509

89:                                               ; preds = %85
  %90 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2510
  %91 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %90, i32 noundef %87), !dbg !2511
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %91, metadata !2264, metadata !DIExpression()), !dbg !2512
  ...
  %92 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %91), !dbg !2514
  call void @exit(i32 noundef 1) #19, !dbg !2515
  unreachable, !dbg !2515

93:                                               ; preds = %85
  %94 = bitcast i64** %22 to i8*, !dbg !2516
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %94) #18, !dbg !2516
  call void @llvm.dbg.value(metadata i64** %22, metadata !2239, metadata !DIExpression(DW_OP_deref)), !dbg !2246
  call void @llvm.dbg.value(metadata i64** %22, metadata !2517, metadata !DIExpression()), !dbg !2527
  call void @llvm.dbg.value(metadata i64 8192, metadata !2524, metadata !DIExpression()), !dbg !2527
  %95 = bitcast i64** %22 to i8**, !dbg !2529
  %96 = call i32 @hipMalloc(i8** noundef nonnull %95, i64 noundef 8192), !dbg !2530
  call void @llvm.dbg.value(metadata i32 %96, metadata !2250, metadata !DIExpression()), !dbg !2531
  %97 = icmp eq i32 %96, 0, !dbg !2533
  br i1 %97, label %102, label %98, !dbg !2534

98:                                               ; preds = %93
  %99 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2535
  %100 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %99, i32 noundef %96), !dbg !2536
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %100, metadata !2264, metadata !DIExpression()), !dbg !2537
  ...
  %101 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %100), !dbg !2539
  call void @exit(i32 noundef 1) #19, !dbg !2540
  unreachable, !dbg !2540

102:                                              ; preds = %93
  %103 = call i32 @__hipPushCallConfiguration(i64 4294967297, i32 1, i64 4294968320, i32 1, i64 noundef 0, %struct.ihipStream_t* noundef null), !dbg !2541
  %104 = icmp eq i32 %103, 0, !dbg !2541
  br i1 %104, label %105, label %127, !dbg !2541

105:                                              ; preds = %102
  %106 = load i64*, i64** %22, align 8, !dbg !2541, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %106, metadata !2239, metadata !DIExpression()), !dbg !2246
  %107 = bitcast i64** %13 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %107), !dbg !2541
  %108 = bitcast %struct.dim3* %14 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %108), !dbg !2541
  %109 = bitcast %struct.dim3* %15 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %109), !dbg !2541
  %110 = bitcast i64* %16 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %110), !dbg !2541
  %111 = bitcast i8** %17 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %111), !dbg !2541
  %112 = bitcast i8** %18 to i8*, !dbg !2541
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %112), !dbg !2541
  store i64* %106, i64** %13, align 8, !dbg !2541, !tbaa !2217
  %113 = bitcast i8** %18 to i64***, !dbg !2541
  store i64** %13, i64*** %113, align 16, !dbg !2541
  %114 = call i32 @__hipPopCallConfiguration(%struct.dim3* nonnull %14, %struct.dim3* nonnull %15, i64* nonnull %16, i8** nonnull %17), !dbg !2541
  %115 = load i64, i64* %16, align 8, !dbg !2541
  %116 = bitcast i8** %17 to %struct.ihipStream_t**, !dbg !2541
  %117 = load %struct.ihipStream_t*, %struct.ihipStream_t** %116, align 8, !dbg !2541
  %118 = bitcast %struct.dim3* %14 to i64*, !dbg !2541
  %119 = load i64, i64* %118, align 8, !dbg !2541
  %120 = getelementptr inbounds %struct.dim3, %struct.dim3* %14, i64 0, i32 2, !dbg !2541
  %121 = load i32, i32* %120, align 8, !dbg !2541
  %122 = bitcast %struct.dim3* %15 to i64*, !dbg !2541
  %123 = load i64, i64* %122, align 8, !dbg !2541
  %124 = getelementptr inbounds %struct.dim3, %struct.dim3* %15, i64 0, i32 2, !dbg !2541
  %125 = load i32, i32* %124, align 8, !dbg !2541
  %126 = call noundef i32 @hipLaunchKernel(i8* noundef bitcast (void (i64*)** @_Z10dummy_initPl to i8*), i64 %119, i32 %121, i64 %123, i32 %125, i8** noundef nonnull %18, i64 noundef %115, %struct.ihipStream_t* noundef %117), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %107), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %108), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %109), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %110), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %111), !dbg !2541
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %112), !dbg !2541
  br label %127, !dbg !2541

127:                                              ; preds = %105, %102
  %128 = call noalias noundef nonnull dereferenceable(8192) i8* @_Znam(i64 noundef 8192) #21, !dbg !2543, !heapallocsite !1648
  %129 = bitcast i8* %128 to i64*, !dbg !2543
  call void @llvm.dbg.value(metadata i64* %129, metadata !2241, metadata !DIExpression()), !dbg !2246
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(8192) %128, i8 0, i64 8192, i1 false), !dbg !2544
  %130 = load i8*, i8** %95, align 8, !dbg !2545, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2239, metadata !DIExpression()), !dbg !2246
  %131 = call i32 @hipMemcpy(i8* noundef nonnull %128, i8* noundef %130, i64 noundef 8192, i32 noundef 2), !dbg !2546
  call void @llvm.dbg.value(metadata i32 %131, metadata !2250, metadata !DIExpression()), !dbg !2547
  %132 = icmp eq i32 %131, 0, !dbg !2549
  br i1 %132, label %137, label %133, !dbg !2550

133:                                              ; preds = %127
  %134 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2551
  %135 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %134, i32 noundef %131), !dbg !2552
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %135, metadata !2264, metadata !DIExpression()), !dbg !2553
  ...
  %136 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %135), !dbg !2555
...
139:                                              ; preds = %216
  ...
  %141 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2578, !tbaa !2375
  %142 = getelementptr i8, i8* %141, i64 -24, !dbg !2578
  %143 = bitcast i8* %142 to i64*, !dbg !2578
  %144 = load i64, i64* %143, align 8, !dbg !2578
  %145 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %144, !dbg !2578
  call void @llvm.dbg.value(metadata i8* %145, metadata !2579, metadata !DIExpression()), !dbg !2589
  call void @llvm.dbg.value(metadata i8 32, metadata !2586, metadata !DIExpression()), !dbg !2589
  call void @llvm.dbg.value(metadata i8* %145, metadata !2591, metadata !DIExpression()), !dbg !2597
  %146 = getelementptr inbounds i8, i8* %145, i64 225, !dbg !2599
  %147 = load i8, i8* %146, align 1, !dbg !2599, !tbaa !2601, !range !2602
  %148 = icmp eq i8 %147, 0, !dbg !2599
  br i1 %148, label %149, label %168, !dbg !2603

149:                                              ; preds = %139
  call void @llvm.dbg.value(metadata i8* %145, metadata !2579, metadata !DIExpression()), !dbg !2589
  call void @llvm.dbg.value(metadata i8* %145, metadata !2591, metadata !DIExpression()), !dbg !2597
  call void @llvm.dbg.value(metadata i8* %145, metadata !2377, metadata !DIExpression()), !dbg !2604
  call void @llvm.dbg.value(metadata i8 32, metadata !2389, metadata !DIExpression()), !dbg !2604
  %150 = getelementptr inbounds i8, i8* %145, i64 240, !dbg !2607
  %151 = bitcast i8* %150 to %"class.std::ctype"**, !dbg !2607
  %152 = load %"class.std::ctype"*, %"class.std::ctype"** %151, align 8, !dbg !2607, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %152, metadata !2403, metadata !DIExpression()), !dbg !2608
  %153 = icmp eq %"class.std::ctype"* %152, null, !dbg !2610
  br i1 %153, label %154, label %155, !dbg !2611
...
155:                                              ; preds = %149
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %152, metadata !2421, metadata !DIExpression()), !dbg !2613
  call void @llvm.dbg.value(metadata i8 32, metadata !2429, metadata !DIExpression()), !dbg !2613
  %156 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %152, i64 0, i32 8, !dbg !2615
  %157 = load i8, i8* %156, align 8, !dbg !2615, !tbaa !2434
  %158 = icmp eq i8 %157, 0, !dbg !2615
  br i1 %158, label %159, label %166, !dbg !2616

159:                                              ; preds = %155
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %152), !dbg !2617
  %160 = bitcast %"class.std::ctype"* %152 to i8 (%"class.std::ctype"*, i8)***, !dbg !2618
  %161 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %160, align 8, !dbg !2618, !tbaa !2375
  %162 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %161, i64 6, !dbg !2618
  %163 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %162, align 8, !dbg !2618
  %164 = call noundef signext i8 %163(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %152, i8 noundef signext 32), !dbg !2618
  %165 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2619, !tbaa !2375
  br label %166, !dbg !2630

166:                                              ; preds = %159, %155
  %167 = phi i8* [ %165, %159 ], [ %141, %155 ], !dbg !2619
  store i8 1, i8* %146, align 1, !dbg !2631, !tbaa !2601
  br label %168, !dbg !2632

168:                                              ; preds = %139, %166
  %169 = phi i8* [ %141, %139 ], [ %167, %166 ], !dbg !2619
  call void @llvm.dbg.value(metadata i8 undef, metadata !2587, metadata !DIExpression()), !dbg !2589
  %170 = getelementptr inbounds i8, i8* %145, i64 224, !dbg !2633
  store i8 32, i8* %170, align 8, !dbg !2634, !tbaa !2635
  ...
  %171 = getelementptr i8, i8* %169, i64 -24, !dbg !2619
  %172 = bitcast i8* %171 to i64*, !dbg !2619
  %173 = load i64, i64* %172, align 8, !dbg !2619
  %174 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %173, !dbg !2619
  call void @llvm.dbg.value(metadata i8* %174, metadata !2637, metadata !DIExpression()), !dbg !2647
  call void @llvm.dbg.value(metadata i64 8, metadata !2644, metadata !DIExpression()), !dbg !2647
  %175 = getelementptr inbounds i8, i8* %174, i64 16, !dbg !2649
  %176 = bitcast i8* %175 to i64*, !dbg !2649
  call void @llvm.dbg.value(metadata i64 undef, metadata !2645, metadata !DIExpression()), !dbg !2647
  store i64 8, i64* %176, align 8, !dbg !2650, !tbaa !2651
  ...
  %179 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout), !dbg !2662
  %180 = call i32 @__hipPushCallConfiguration(i64 4294967297, i32 1, i64 4294968320, i32 1, i64 noundef 0, %struct.ihipStream_t* noundef null), !dbg !2663
  %181 = icmp eq i32 %180, 0, !dbg !2663
  br i1 %181, label %230, label %264, !dbg !2664

182:                                              ; preds = %137, %216
  %183 = phi i64 [ 0, %137 ], [ %228, %216 ]
  call void @llvm.dbg.value(metadata i64 %183, metadata !2242, metadata !DIExpression()), !dbg !2560
  %184 = and i64 %183, 15, !dbg !2665
  %185 = icmp eq i64 %184, 0, !dbg !2669
  br i1 %185, label %186, label %188, !dbg !2670
...
188:                                              ; preds = %186, %182
  ...
  %189 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2677, !tbaa !2375
  %190 = getelementptr i8, i8* %189, i64 -24, !dbg !2677
  %191 = bitcast i8* %190 to i64*, !dbg !2677
  %192 = load i64, i64* %191, align 8, !dbg !2677
  %193 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %192, !dbg !2677
  call void @llvm.dbg.value(metadata i8* %193, metadata !2579, metadata !DIExpression()), !dbg !2678
  call void @llvm.dbg.value(metadata i8 32, metadata !2586, metadata !DIExpression()), !dbg !2678
  call void @llvm.dbg.value(metadata i8* %193, metadata !2591, metadata !DIExpression()), !dbg !2680
  %194 = getelementptr inbounds i8, i8* %193, i64 225, !dbg !2682
  %195 = load i8, i8* %194, align 1, !dbg !2682, !tbaa !2601, !range !2602
  %196 = icmp eq i8 %195, 0, !dbg !2682
  br i1 %196, label %197, label %216, !dbg !2683

197:                                              ; preds = %188
  call void @llvm.dbg.value(metadata i8* %193, metadata !2579, metadata !DIExpression()), !dbg !2678
  call void @llvm.dbg.value(metadata i8* %193, metadata !2591, metadata !DIExpression()), !dbg !2680
  call void @llvm.dbg.value(metadata i8* %193, metadata !2377, metadata !DIExpression()), !dbg !2684
  call void @llvm.dbg.value(metadata i8 32, metadata !2389, metadata !DIExpression()), !dbg !2684
  %198 = getelementptr inbounds i8, i8* %193, i64 240, !dbg !2686
  %199 = bitcast i8* %198 to %"class.std::ctype"**, !dbg !2686
  %200 = load %"class.std::ctype"*, %"class.std::ctype"** %199, align 8, !dbg !2686, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %200, metadata !2403, metadata !DIExpression()), !dbg !2687
  %201 = icmp eq %"class.std::ctype"* %200, null, !dbg !2689
  br i1 %201, label %202, label %203, !dbg !2690
...
203:                                              ; preds = %197
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %200, metadata !2421, metadata !DIExpression()), !dbg !2692
  call void @llvm.dbg.value(metadata i8 32, metadata !2429, metadata !DIExpression()), !dbg !2692
  %204 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %200, i64 0, i32 8, !dbg !2694
  %205 = load i8, i8* %204, align 8, !dbg !2694, !tbaa !2434
  %206 = icmp eq i8 %205, 0, !dbg !2694
  br i1 %206, label %207, label %214, !dbg !2695

207:                                              ; preds = %203
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %200), !dbg !2696
  %208 = bitcast %"class.std::ctype"* %200 to i8 (%"class.std::ctype"*, i8)***, !dbg !2697
  %209 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %208, align 8, !dbg !2697, !tbaa !2375
  %210 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %209, i64 6, !dbg !2697
  %211 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %210, align 8, !dbg !2697
  %212 = call noundef signext i8 %211(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %200, i8 noundef signext 32), !dbg !2697
  %213 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2698, !tbaa !2375
  br label %214, !dbg !2700

214:                                              ; preds = %207, %203
  %215 = phi i8* [ %213, %207 ], [ %189, %203 ], !dbg !2698
  store i8 1, i8* %194, align 1, !dbg !2701, !tbaa !2601
  br label %216, !dbg !2702

216:                                              ; preds = %188, %214
  %217 = phi i8* [ %189, %188 ], [ %215, %214 ], !dbg !2698
  call void @llvm.dbg.value(metadata i8 undef, metadata !2587, metadata !DIExpression()), !dbg !2678
  %218 = getelementptr inbounds i8, i8* %193, i64 224, !dbg !2703
  store i8 32, i8* %218, align 8, !dbg !2704, !tbaa !2635
  ...
  %219 = getelementptr i8, i8* %217, i64 -24, !dbg !2698
  %220 = bitcast i8* %219 to i64*, !dbg !2698
  %221 = load i64, i64* %220, align 8, !dbg !2698
  call void @llvm.dbg.value(metadata !DIArgList(i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %221), metadata !2637, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 1, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)), !dbg !2706
  call void @llvm.dbg.value(metadata i64 8, metadata !2644, metadata !DIExpression()), !dbg !2706
  %222 = getelementptr i8, i8* bitcast (i64* getelementptr inbounds (%"class.std::basic_ostream", %"class.std::basic_ostream"* @_ZSt4cout, i64 0, i32 1, i32 0, i32 1) to i8*), i64 %221, !dbg !2708
  %223 = bitcast i8* %222 to i64*, !dbg !2708
  call void @llvm.dbg.value(metadata i64 undef, metadata !2645, metadata !DIExpression()), !dbg !2706
  store i64 8, i64* %223, align 8, !dbg !2709, !tbaa !2651
  %224 = getelementptr inbounds i64, i64* %129, i64 %183, !dbg !2710
  %225 = load i64, i64* %224, align 8, !dbg !2710, !tbaa !2711
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* @_ZSt4cout, metadata !2712, metadata !DIExpression()), !dbg !2719
  call void @llvm.dbg.value(metadata i64 %225, metadata !2718, metadata !DIExpression()), !dbg !2719
  %226 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertIlEERSoT_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %225), !dbg !2721
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %226, metadata !2285, metadata !DIExpression()), !dbg !2722
  ...
  %227 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %226, i8* noundef nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i64 noundef 1), !dbg !2724
  %228 = add nuw nsw i64 %183, 1, !dbg !2725
  call void @llvm.dbg.value(metadata i64 %228, metadata !2242, metadata !DIExpression()), !dbg !2560
  %229 = icmp eq i64 %228, 128, !dbg !2726
  br i1 %229, label %139, label %182, !dbg !2561, !llvm.loop !2727

230:                                              ; preds = %168
  %231 = load i64*, i64** %20, align 8, !dbg !2730, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %231, metadata !2233, metadata !DIExpression()), !dbg !2246
  %232 = load i64*, i64** %21, align 8, !dbg !2731, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %232, metadata !2238, metadata !DIExpression()), !dbg !2246
  %233 = load i64*, i64** %22, align 8, !dbg !2732, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %233, metadata !2239, metadata !DIExpression()), !dbg !2246
  %234 = bitcast i64** %4 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %234), !dbg !2664
  %235 = bitcast i64** %5 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %235), !dbg !2664
  %236 = bitcast i64** %6 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %236), !dbg !2664
  %237 = bitcast i32* %7 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %237), !dbg !2664
  %238 = bitcast %struct.dim3* %8 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %238), !dbg !2664
  %239 = bitcast %struct.dim3* %9 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %239), !dbg !2664
  %240 = bitcast i64* %10 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %240), !dbg !2664
  %241 = bitcast i8** %11 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %241), !dbg !2664
  %242 = bitcast [4 x i8*]* %12 to i8*, !dbg !2664
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %242), !dbg !2664
  store i64* %231, i64** %4, align 8, !dbg !2664, !tbaa !2217
  store i64* %232, i64** %5, align 8, !dbg !2664, !tbaa !2217
  store i64* %233, i64** %6, align 8, !dbg !2664, !tbaa !2217
  store i32 %0, i32* %7, align 4, !dbg !2664, !tbaa !2221
  %243 = getelementptr inbounds [4 x i8*], [4 x i8*]* %12, i64 0, i64 0, !dbg !2664
  %244 = bitcast [4 x i8*]* %12 to i64***, !dbg !2664
  store i64** %4, i64*** %244, align 16, !dbg !2664
  %245 = getelementptr inbounds [4 x i8*], [4 x i8*]* %12, i64 0, i64 1, !dbg !2664
  %246 = bitcast i8** %245 to i64***, !dbg !2664
  store i64** %5, i64*** %246, align 8, !dbg !2664
  %247 = getelementptr inbounds [4 x i8*], [4 x i8*]* %12, i64 0, i64 2, !dbg !2664
  %248 = bitcast i8** %247 to i64***, !dbg !2664
  store i64** %6, i64*** %248, align 16, !dbg !2664
  %249 = getelementptr inbounds [4 x i8*], [4 x i8*]* %12, i64 0, i64 3, !dbg !2664
  %250 = bitcast i8** %249 to i32**, !dbg !2664
  store i32* %7, i32** %250, align 8, !dbg !2664
  %251 = call i32 @__hipPopCallConfiguration(%struct.dim3* nonnull %8, %struct.dim3* nonnull %9, i64* nonnull %10, i8** nonnull %11), !dbg !2664
  %252 = load i64, i64* %10, align 8, !dbg !2664
  %253 = bitcast i8** %11 to %struct.ihipStream_t**, !dbg !2664
  %254 = load %struct.ihipStream_t*, %struct.ihipStream_t** %253, align 8, !dbg !2664
  %255 = bitcast %struct.dim3* %8 to i64*, !dbg !2664
  %256 = load i64, i64* %255, align 8, !dbg !2664
  %257 = getelementptr inbounds %struct.dim3, %struct.dim3* %8, i64 0, i32 2, !dbg !2664
  %258 = load i32, i32* %257, align 8, !dbg !2664
  %259 = bitcast %struct.dim3* %9 to i64*, !dbg !2664
  %260 = load i64, i64* %259, align 8, !dbg !2664
  %261 = getelementptr inbounds %struct.dim3, %struct.dim3* %9, i64 0, i32 2, !dbg !2664
  %262 = load i32, i32* %261, align 8, !dbg !2664
  %263 = call noundef i32 @hipLaunchKernel(i8* noundef bitcast (void (i64*, i64*, i64*, i32)** @_Z15tick_all_kernelPU7_AtomicmPmPli to i8*), i64 %256, i32 %258, i64 %260, i32 %262, i8** noundef nonnull %243, i64 noundef %252, %struct.ihipStream_t* noundef %254), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %234), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %235), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %236), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %237), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %238), !dbg !2664
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %239), !dbg !2664
  ...
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %242), !dbg !2664
  br label %264, !dbg !2664

264:                                              ; preds = %230, %168
  %265 = bitcast <2 x i64>* %2 to i8*
  br label %266, !dbg !2733

266:                                              ; preds = %280, %264
  %267 = phi i64 [ %281, %280 ], [ 64, %264 ]
  br label %268, !dbg !2734

268:                                              ; preds = %266, %276
  call void @llvm.dbg.value(metadata i64 %267, metadata !2229, metadata !DIExpression()), !dbg !2246
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %265) #18, !dbg !2761
  ...
  br label %269, !dbg !2734

269:                                              ; preds = %272, %268
  %270 = call i32 @nanosleep(%struct.timespec* noundef nonnull %3, %struct.timespec* noundef nonnull %3), !dbg !2764
  %271 = icmp eq i32 %270, -1, !dbg !2765
  br i1 %271, label %272, label %276, !dbg !2766

272:                                              ; preds = %269
  %273 = tail call i32* @__errno_location() #22, !dbg !2767
  %274 = load i32, i32* %273, align 4, !dbg !2767, !tbaa !2221
  %275 = icmp eq i32 %274, 4, !dbg !2768
  br i1 %275, label %269, label %276, !dbg !2734, !llvm.loop !2769

276:                                              ; preds = %269, %272
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %265) #18, !dbg !2771
  %277 = load i64*, i64** %20, align 8, !dbg !2772, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %277, metadata !2233, metadata !DIExpression()), !dbg !2246
  %278 = load atomic i64, i64* %277 seq_cst, align 8, !dbg !2773, !tbaa !2439
  %279 = icmp eq i64 %278, 0, !dbg !2774
  br i1 %279, label %268, label %280, !dbg !2775

280:                                              ; preds = %276
  %281 = add nsw i64 %267, -1, !dbg !2776
  call void @llvm.dbg.value(metadata i64 %281, metadata !2229, metadata !DIExpression()), !dbg !2246
  %282 = icmp ugt i64 %267, 1, !dbg !2777
  br i1 %282, label %266, label %283, !dbg !2778, !llvm.loop !2779

283:                                              ; preds = %280
  %284 = load i64*, i64** %20, align 8, !dbg !2781, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %284, metadata !2233, metadata !DIExpression()), !dbg !2246
  %285 = load atomic i64, i64* %284 seq_cst, align 8, !dbg !2783, !tbaa !2439
  %286 = icmp eq i64 %285, 0, !dbg !2784
  br i1 %286, label %316, label %287, !dbg !2785
...
287:                                              ; preds = %283
  ...
  %289 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2793, !tbaa !2375
  %290 = getelementptr i8, i8* %289, i64 -24, !dbg !2793
  %291 = bitcast i8* %290 to i64*, !dbg !2793
  %292 = load i64, i64* %291, align 8, !dbg !2793
  %293 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %292, !dbg !2793
  call void @llvm.dbg.value(metadata i8* %293, metadata !2377, metadata !DIExpression()), !dbg !2794
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !2794
  %294 = getelementptr inbounds i8, i8* %293, i64 240, !dbg !2796
  %295 = bitcast i8* %294 to %"class.std::ctype"**, !dbg !2796
  %296 = load %"class.std::ctype"*, %"class.std::ctype"** %295, align 8, !dbg !2796, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %296, metadata !2403, metadata !DIExpression()), !dbg !2797
  %297 = icmp eq %"class.std::ctype"* %296, null, !dbg !2799
  br i1 %297, label %298, label %299, !dbg !2800
...
299:                                              ; preds = %287
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %296, metadata !2421, metadata !DIExpression()), !dbg !2802
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !2802
  %300 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %296, i64 0, i32 8, !dbg !2804
  %301 = load i8, i8* %300, align 8, !dbg !2804, !tbaa !2434
  %302 = icmp eq i8 %301, 0, !dbg !2804
  br i1 %302, label %306, label %303, !dbg !2805

303:                                              ; preds = %299
  %304 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %296, i64 0, i32 9, i64 10, !dbg !2806
  %305 = load i8, i8* %304, align 1, !dbg !2806, !tbaa !2439
  br label %312, !dbg !2807

306:                                              ; preds = %299
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %296), !dbg !2808
  %307 = bitcast %"class.std::ctype"* %296 to i8 (%"class.std::ctype"*, i8)***, !dbg !2809
  %308 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %307, align 8, !dbg !2809, !tbaa !2375
  %309 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %308, i64 6, !dbg !2809
  %310 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %309, align 8, !dbg !2809
  %311 = call noundef signext i8 %310(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %296, i8 noundef signext 10), !dbg !2809
  br label %312, !dbg !2810

312:                                              ; preds = %303, %306
  %313 = phi i8 [ %305, %303 ], [ %311, %306 ], !dbg !2802
  %314 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %313), !dbg !2811
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %314, metadata !2353, metadata !DIExpression()), !dbg !2812
  %315 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %314), !dbg !2814
  br label %316, !dbg !2815

316:                                              ; preds = %312, %283
  %317 = load i8*, i8** %78, align 8, !dbg !2816, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2238, metadata !DIExpression()), !dbg !2246
  %318 = call i32 @hipMemcpy(i8* noundef nonnull %75, i8* noundef %317, i64 noundef 8192, i32 noundef 2), !dbg !2817
  call void @llvm.dbg.value(metadata i32 %318, metadata !2250, metadata !DIExpression()), !dbg !2818
  %319 = icmp eq i32 %318, 0, !dbg !2820
  br i1 %319, label %324, label %320, !dbg !2821

320:                                              ; preds = %316
  %321 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2822
  %322 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %321, i32 noundef %318), !dbg !2823
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %322, metadata !2264, metadata !DIExpression()), !dbg !2824
  ...
  %323 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %322), !dbg !2826
...
324:                                              ; preds = %316
  ...
  %325 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.8, i64 0, i64 0), i64 noundef 23), !dbg !2830
  %326 = load i64*, i64** %20, align 8, !dbg !2831, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* %326, metadata !2233, metadata !DIExpression()), !dbg !2246
  %327 = load atomic i64, i64* %326 seq_cst, align 8, !dbg !2832, !tbaa !2439
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* @_ZSt4cout, metadata !2833, metadata !DIExpression()), !dbg !2840
  call void @llvm.dbg.value(metadata i64 %327, metadata !2839, metadata !DIExpression()), !dbg !2840
  %328 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertImEERSoT_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %327), !dbg !2842
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %328, metadata !2285, metadata !DIExpression()), !dbg !2843
  ...
  %329 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %328, i8* noundef nonnull getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i64 0, i64 0), i64 noundef 35), !dbg !2845
  call void @llvm.dbg.value(metadata i64 0, metadata !2244, metadata !DIExpression()), !dbg !2846
  br label %423, !dbg !2847
...
330:                                              ; preds = %457
  ...
  %332 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2854, !tbaa !2375
  %333 = getelementptr i8, i8* %332, i64 -24, !dbg !2854
  %334 = bitcast i8* %333 to i64*, !dbg !2854
  %335 = load i64, i64* %334, align 8, !dbg !2854
  %336 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %335, !dbg !2854
  call void @llvm.dbg.value(metadata i8* %336, metadata !2579, metadata !DIExpression()), !dbg !2855
  call void @llvm.dbg.value(metadata i8 32, metadata !2586, metadata !DIExpression()), !dbg !2855
  call void @llvm.dbg.value(metadata i8* %336, metadata !2591, metadata !DIExpression()), !dbg !2857
  %337 = getelementptr inbounds i8, i8* %336, i64 225, !dbg !2859
  %338 = load i8, i8* %337, align 1, !dbg !2859, !tbaa !2601, !range !2602
  %339 = icmp eq i8 %338, 0, !dbg !2859
  br i1 %339, label %340, label %359, !dbg !2860

340:                                              ; preds = %330
  call void @llvm.dbg.value(metadata i8* %336, metadata !2579, metadata !DIExpression()), !dbg !2855
  call void @llvm.dbg.value(metadata i8* %336, metadata !2591, metadata !DIExpression()), !dbg !2857
  call void @llvm.dbg.value(metadata i8* %336, metadata !2377, metadata !DIExpression()), !dbg !2861
  call void @llvm.dbg.value(metadata i8 32, metadata !2389, metadata !DIExpression()), !dbg !2861
  %341 = getelementptr inbounds i8, i8* %336, i64 240, !dbg !2863
  %342 = bitcast i8* %341 to %"class.std::ctype"**, !dbg !2863
  %343 = load %"class.std::ctype"*, %"class.std::ctype"** %342, align 8, !dbg !2863, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %343, metadata !2403, metadata !DIExpression()), !dbg !2864
  %344 = icmp eq %"class.std::ctype"* %343, null, !dbg !2866
  br i1 %344, label %345, label %346, !dbg !2867
...
346:                                              ; preds = %340
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %343, metadata !2421, metadata !DIExpression()), !dbg !2869
  call void @llvm.dbg.value(metadata i8 32, metadata !2429, metadata !DIExpression()), !dbg !2869
  %347 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %343, i64 0, i32 8, !dbg !2871
  %348 = load i8, i8* %347, align 8, !dbg !2871, !tbaa !2434
  %349 = icmp eq i8 %348, 0, !dbg !2871
  br i1 %349, label %350, label %357, !dbg !2872

350:                                              ; preds = %346
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %343), !dbg !2873
  %351 = bitcast %"class.std::ctype"* %343 to i8 (%"class.std::ctype"*, i8)***, !dbg !2874
  %352 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %351, align 8, !dbg !2874, !tbaa !2375
  %353 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %352, i64 6, !dbg !2874
  %354 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %353, align 8, !dbg !2874
  %355 = call noundef signext i8 %354(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %343, i8 noundef signext 32), !dbg !2874
  %356 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2875, !tbaa !2375
  br label %357, !dbg !2877

357:                                              ; preds = %350, %346
  %358 = phi i8* [ %356, %350 ], [ %332, %346 ], !dbg !2875
  store i8 1, i8* %337, align 1, !dbg !2878, !tbaa !2601
  br label %359, !dbg !2879

359:                                              ; preds = %330, %357
  %360 = phi i8* [ %332, %330 ], [ %358, %357 ], !dbg !2875
  call void @llvm.dbg.value(metadata i8 undef, metadata !2587, metadata !DIExpression()), !dbg !2855
  %361 = getelementptr inbounds i8, i8* %336, i64 224, !dbg !2880
  store i8 32, i8* %361, align 8, !dbg !2881, !tbaa !2635
  ...
  %362 = getelementptr i8, i8* %360, i64 -24, !dbg !2875
  %363 = bitcast i8* %362 to i64*, !dbg !2875
  %364 = load i64, i64* %363, align 8, !dbg !2875
  %365 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %364, !dbg !2875
  call void @llvm.dbg.value(metadata i8* %365, metadata !2637, metadata !DIExpression()), !dbg !2883
  call void @llvm.dbg.value(metadata i64 8, metadata !2644, metadata !DIExpression()), !dbg !2883
  %366 = getelementptr inbounds i8, i8* %365, i64 16, !dbg !2885
  %367 = bitcast i8* %366 to i64*, !dbg !2885
  call void @llvm.dbg.value(metadata i64 undef, metadata !2645, metadata !DIExpression()), !dbg !2883
  store i64 8, i64* %367, align 8, !dbg !2886, !tbaa !2651
  ...
  %370 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2897, !tbaa !2375
  %371 = getelementptr i8, i8* %370, i64 -24, !dbg !2897
  %372 = bitcast i8* %371 to i64*, !dbg !2897
  %373 = load i64, i64* %372, align 8, !dbg !2897
  %374 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %373, !dbg !2897
  call void @llvm.dbg.value(metadata i8* %374, metadata !2377, metadata !DIExpression()), !dbg !2898
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !2898
  %375 = getelementptr inbounds i8, i8* %374, i64 240, !dbg !2900
  %376 = bitcast i8* %375 to %"class.std::ctype"**, !dbg !2900
  %377 = load %"class.std::ctype"*, %"class.std::ctype"** %376, align 8, !dbg !2900, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %377, metadata !2403, metadata !DIExpression()), !dbg !2901
  %378 = icmp eq %"class.std::ctype"* %377, null, !dbg !2903
  br i1 %378, label %379, label %380, !dbg !2904
...
380:                                              ; preds = %359
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %377, metadata !2421, metadata !DIExpression()), !dbg !2906
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !2906
  %381 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %377, i64 0, i32 8, !dbg !2908
  %382 = load i8, i8* %381, align 8, !dbg !2908, !tbaa !2434
  %383 = icmp eq i8 %382, 0, !dbg !2908
  br i1 %383, label %387, label %384, !dbg !2909

384:                                              ; preds = %380
  %385 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %377, i64 0, i32 9, i64 10, !dbg !2910
  %386 = load i8, i8* %385, align 1, !dbg !2910, !tbaa !2439
  br label %393, !dbg !2911

387:                                              ; preds = %380
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %377), !dbg !2912
  %388 = bitcast %"class.std::ctype"* %377 to i8 (%"class.std::ctype"*, i8)***, !dbg !2913
  %389 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %388, align 8, !dbg !2913, !tbaa !2375
  %390 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %389, i64 6, !dbg !2913
  %391 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %390, align 8, !dbg !2913
  %392 = call noundef signext i8 %391(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %377, i8 noundef signext 10), !dbg !2913
  br label %393, !dbg !2914

393:                                              ; preds = %384, %387
  %394 = phi i8 [ %386, %384 ], [ %392, %387 ], !dbg !2906
  %395 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %394), !dbg !2915
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %395, metadata !2353, metadata !DIExpression()), !dbg !2916
  %396 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %395), !dbg !2918
  %397 = load i8*, i8** %78, align 8, !dbg !2919, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2238, metadata !DIExpression()), !dbg !2246
  %398 = call i32 @hipFree(i8* noundef %397), !dbg !2920
  call void @llvm.dbg.value(metadata i32 %398, metadata !2250, metadata !DIExpression()), !dbg !2921
  %399 = icmp eq i32 %398, 0, !dbg !2923
  br i1 %399, label %404, label %400, !dbg !2924

400:                                              ; preds = %393
  %401 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2925
  %402 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %401, i32 noundef %398), !dbg !2926
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %402, metadata !2264, metadata !DIExpression()), !dbg !2927
  ...
  %403 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %402), !dbg !2929
  call void @exit(i32 noundef 1) #19, !dbg !2930
  unreachable, !dbg !2930

404:                                              ; preds = %393
  %405 = load i8*, i8** %66, align 8, !dbg !2931, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2233, metadata !DIExpression()), !dbg !2246
  %406 = call i32 @hipFree(i8* noundef %405), !dbg !2932
  call void @llvm.dbg.value(metadata i32 %406, metadata !2250, metadata !DIExpression()), !dbg !2933
  %407 = icmp eq i32 %406, 0, !dbg !2935
  br i1 %407, label %412, label %408, !dbg !2936

408:                                              ; preds = %404
  %409 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2937
  %410 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %409, i32 noundef %406), !dbg !2938
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %410, metadata !2264, metadata !DIExpression()), !dbg !2939
  ...
  %411 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %410), !dbg !2941
  call void @exit(i32 noundef 1) #19, !dbg !2942
  unreachable, !dbg !2942

412:                                              ; preds = %404
  %413 = load i8*, i8** %95, align 8, !dbg !2943, !tbaa !2217
  call void @llvm.dbg.value(metadata i64* undef, metadata !2239, metadata !DIExpression()), !dbg !2246
  %414 = call i32 @hipFree(i8* noundef %413), !dbg !2944
  call void @llvm.dbg.value(metadata i32 %414, metadata !2250, metadata !DIExpression()), !dbg !2945
  %415 = icmp eq i32 %414, 0, !dbg !2947
  br i1 %415, label %420, label %416, !dbg !2948

416:                                              ; preds = %412
  %417 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !2949
  %418 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %417, i32 noundef %414), !dbg !2950
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %418, metadata !2264, metadata !DIExpression()), !dbg !2951
  ...
  %419 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %418), !dbg !2953
  call void @exit(i32 noundef 1) #19, !dbg !2954
  unreachable, !dbg !2954

420:                                              ; preds = %412
  call void @_ZdaPv(i8* noundef nonnull %75) #23, !dbg !2955
  call void @_ZdaPv(i8* noundef nonnull %128) #23, !dbg !2956
  ...
  %422 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout), !dbg !2964
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %94) #18, !dbg !2965
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %77) #18, !dbg !2965
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %65) #18, !dbg !2965
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %23) #18, !dbg !2965
  ret void, !dbg !2965

423:                                              ; preds = %324, %457
  %424 = phi i64 [ 0, %324 ], [ %469, %457 ]
  call void @llvm.dbg.value(metadata i64 %424, metadata !2244, metadata !DIExpression()), !dbg !2846
  %425 = and i64 %424, 15, !dbg !2966
  %426 = icmp eq i64 %425, 0, !dbg !2970
  br i1 %426, label %427, label %429, !dbg !2971
...
429:                                              ; preds = %427, %423
  ...
  %430 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2978, !tbaa !2375
  %431 = getelementptr i8, i8* %430, i64 -24, !dbg !2978
  %432 = bitcast i8* %431 to i64*, !dbg !2978
  %433 = load i64, i64* %432, align 8, !dbg !2978
  %434 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %433, !dbg !2978
  call void @llvm.dbg.value(metadata i8* %434, metadata !2579, metadata !DIExpression()), !dbg !2979
  call void @llvm.dbg.value(metadata i8 32, metadata !2586, metadata !DIExpression()), !dbg !2979
  call void @llvm.dbg.value(metadata i8* %434, metadata !2591, metadata !DIExpression()), !dbg !2981
  %435 = getelementptr inbounds i8, i8* %434, i64 225, !dbg !2983
  %436 = load i8, i8* %435, align 1, !dbg !2983, !tbaa !2601, !range !2602
  %437 = icmp eq i8 %436, 0, !dbg !2983
  br i1 %437, label %438, label %457, !dbg !2984

438:                                              ; preds = %429
  call void @llvm.dbg.value(metadata i8* %434, metadata !2579, metadata !DIExpression()), !dbg !2979
  call void @llvm.dbg.value(metadata i8* %434, metadata !2591, metadata !DIExpression()), !dbg !2981
  call void @llvm.dbg.value(metadata i8* %434, metadata !2377, metadata !DIExpression()), !dbg !2985
  call void @llvm.dbg.value(metadata i8 32, metadata !2389, metadata !DIExpression()), !dbg !2985
  %439 = getelementptr inbounds i8, i8* %434, i64 240, !dbg !2987
  %440 = bitcast i8* %439 to %"class.std::ctype"**, !dbg !2987
  %441 = load %"class.std::ctype"*, %"class.std::ctype"** %440, align 8, !dbg !2987, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %441, metadata !2403, metadata !DIExpression()), !dbg !2988
  %442 = icmp eq %"class.std::ctype"* %441, null, !dbg !2990
  br i1 %442, label %443, label %444, !dbg !2991
...
444:                                              ; preds = %438
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %441, metadata !2421, metadata !DIExpression()), !dbg !2993
  call void @llvm.dbg.value(metadata i8 32, metadata !2429, metadata !DIExpression()), !dbg !2993
  %445 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %441, i64 0, i32 8, !dbg !2995
  %446 = load i8, i8* %445, align 8, !dbg !2995, !tbaa !2434
  %447 = icmp eq i8 %446, 0, !dbg !2995
  br i1 %447, label %448, label %455, !dbg !2996

448:                                              ; preds = %444
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %441), !dbg !2997
  %449 = bitcast %"class.std::ctype"* %441 to i8 (%"class.std::ctype"*, i8)***, !dbg !2998
  %450 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %449, align 8, !dbg !2998, !tbaa !2375
  %451 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %450, i64 6, !dbg !2998
  %452 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %451, align 8, !dbg !2998
  %453 = call noundef signext i8 %452(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %441, i8 noundef signext 32), !dbg !2998
  %454 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !2999, !tbaa !2375
  br label %455, !dbg !3001

455:                                              ; preds = %448, %444
  %456 = phi i8* [ %454, %448 ], [ %430, %444 ], !dbg !2999
  store i8 1, i8* %435, align 1, !dbg !3002, !tbaa !2601
  br label %457, !dbg !3003

457:                                              ; preds = %429, %455
  %458 = phi i8* [ %430, %429 ], [ %456, %455 ], !dbg !2999
  call void @llvm.dbg.value(metadata i8 undef, metadata !2587, metadata !DIExpression()), !dbg !2979
  %459 = getelementptr inbounds i8, i8* %434, i64 224, !dbg !3004
  store i8 32, i8* %459, align 8, !dbg !3005, !tbaa !2635
  ...
  %460 = getelementptr i8, i8* %458, i64 -24, !dbg !2999
  %461 = bitcast i8* %460 to i64*, !dbg !2999
  %462 = load i64, i64* %461, align 8, !dbg !2999
  call void @llvm.dbg.value(metadata !DIArgList(i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %462), metadata !2637, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 1, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)), !dbg !3007
  call void @llvm.dbg.value(metadata i64 8, metadata !2644, metadata !DIExpression()), !dbg !3007
  %463 = getelementptr i8, i8* bitcast (i64* getelementptr inbounds (%"class.std::basic_ostream", %"class.std::basic_ostream"* @_ZSt4cout, i64 0, i32 1, i32 0, i32 1) to i8*), i64 %462, !dbg !3009
  %464 = bitcast i8* %463 to i64*, !dbg !3009
  call void @llvm.dbg.value(metadata i64 undef, metadata !2645, metadata !DIExpression()), !dbg !3007
  store i64 8, i64* %464, align 8, !dbg !3010, !tbaa !2651
  %465 = getelementptr inbounds i64, i64* %76, i64 %424, !dbg !3011
  %466 = load i64, i64* %465, align 8, !dbg !3011, !tbaa !2711
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* @_ZSt4cout, metadata !2833, metadata !DIExpression()), !dbg !3012
  call void @llvm.dbg.value(metadata i64 %466, metadata !2839, metadata !DIExpression()), !dbg !3012
  %467 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertImEERSoT_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %466), !dbg !3014
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %467, metadata !2285, metadata !DIExpression()), !dbg !3015
  ...
  %468 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %467, i8* noundef nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i64 noundef 1), !dbg !3017
  %469 = add nuw nsw i64 %424, 1, !dbg !3018
  call void @llvm.dbg.value(metadata i64 %469, metadata !2244, metadata !DIExpression()), !dbg !2846
  %470 = icmp eq i64 %469, 128, !dbg !3019
  br i1 %470, label %330, label %423, !dbg !2847, !llvm.loop !3020
}
...
define dso_local void @_Z27__device_stub__dummy_kernelv() #3 {
  ...
  %18 = call noundef i32 @hipLaunchKernel(i8* noundef bitcast (void ()** @_Z12dummy_kernelv to i8*), i64 %11, i32 %13, i64 %15, i32 %17, i8** noundef nonnull %5, i64 noundef %7, %struct.ihipStream_t* noundef %9)
  ret void
}
...
define dso_local noundef i32 @main(i32 noundef %0, i8** nocapture noundef readnone %1) local_unnamed_addr #3 !dbg !2119 {
  ...
  %9 = getelementptr inbounds %struct.hipDeviceProp_t, %struct.hipDeviceProp_t* %8, i64 0, i32 0, i64 0, !dbg !3043
  call void @llvm.lifetime.start.p0i8(i64 792, i8* nonnull %9) #18, !dbg !3043
  call void @llvm.dbg.declare(metadata %struct.hipDeviceProp_t* %8, metadata !2125, metadata !DIExpression()), !dbg !3044
  %10 = call i32 @hipGetDeviceProperties(%struct.hipDeviceProp_t* noundef nonnull %8, i32 noundef 0), !dbg !3045
  call void @llvm.dbg.value(metadata i32 %10, metadata !2250, metadata !DIExpression()), !dbg !3046
  %11 = icmp eq i32 %10, 0, !dbg !3048
  br i1 %11, label %16, label %12, !dbg !3049

12:                                               ; preds = %2
  %13 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.14, i64 0, i64 0)), !dbg !3050
  %14 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %13, i32 noundef %10), !dbg !3051
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %14, metadata !2264, metadata !DIExpression()), !dbg !3052
  ...
  %15 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %14), !dbg !3054
...
16:                                               ; preds = %2
  ...
  %18 = getelementptr inbounds %struct.hipDeviceProp_t, %struct.hipDeviceProp_t* %8, i64 0, i32 13, !dbg !3064
  %19 = load i32, i32* %18, align 4, !dbg !3064, !tbaa !3065
  %20 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %19), !dbg !3068
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %20, metadata !2264, metadata !DIExpression()), !dbg !3069
  ...
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %20, metadata !2369, metadata !DIExpression()), !dbg !3071
  %21 = bitcast %"class.std::basic_ostream"* %20 to i8**, !dbg !3073
  %22 = load i8*, i8** %21, align 8, !dbg !3073, !tbaa !2375
  %23 = getelementptr i8, i8* %22, i64 -24, !dbg !3073
  %24 = bitcast i8* %23 to i64*, !dbg !3073
  %25 = load i64, i64* %24, align 8, !dbg !3073
  %26 = bitcast %"class.std::basic_ostream"* %20 to i8*, !dbg !3073
  %27 = getelementptr inbounds i8, i8* %26, i64 %25, !dbg !3073
  call void @llvm.dbg.value(metadata i8* %27, metadata !2377, metadata !DIExpression()), !dbg !3074
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !3074
  %28 = getelementptr inbounds i8, i8* %27, i64 240, !dbg !3076
  %29 = bitcast i8* %28 to %"class.std::ctype"**, !dbg !3076
  %30 = load %"class.std::ctype"*, %"class.std::ctype"** %29, align 8, !dbg !3076, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %30, metadata !2403, metadata !DIExpression()), !dbg !3077
  %31 = icmp eq %"class.std::ctype"* %30, null, !dbg !3079
...
33:                                               ; preds = %16
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %30, metadata !2421, metadata !DIExpression()), !dbg !3082
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !3082
  %34 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %30, i64 0, i32 8, !dbg !3084
  %35 = load i8, i8* %34, align 8, !dbg !3084, !tbaa !2434
  %36 = icmp eq i8 %35, 0, !dbg !3084
  br i1 %36, label %40, label %37, !dbg !3085

37:                                               ; preds = %33
  %38 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %30, i64 0, i32 9, i64 10, !dbg !3086
  %39 = load i8, i8* %38, align 1, !dbg !3086, !tbaa !2439
  br label %46, !dbg !3087

40:                                               ; preds = %33
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %30), !dbg !3088
  %41 = bitcast %"class.std::ctype"* %30 to i8 (%"class.std::ctype"*, i8)***, !dbg !3089
  %42 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %41, align 8, !dbg !3089, !tbaa !2375
  %43 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %42, i64 6, !dbg !3089
  %44 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %43, align 8, !dbg !3089
  %45 = call noundef signext i8 %44(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %30, i8 noundef signext 10), !dbg !3089
  br label %46, !dbg !3090

46:                                               ; preds = %37, %40
  %47 = phi i8 [ %39, %37 ], [ %45, %40 ], !dbg !3082
  %48 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %20, i8 noundef signext %47), !dbg !3091
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %48, metadata !2353, metadata !DIExpression()), !dbg !3092
  %49 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %48), !dbg !3094
  ...
  %51 = getelementptr inbounds %struct.hipDeviceProp_t, %struct.hipDeviceProp_t* %8, i64 0, i32 12, !dbg !3100
  %52 = load i32, i32* %51, align 8, !dbg !3100, !tbaa !3101
  %53 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %52), !dbg !3102
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %53, metadata !2264, metadata !DIExpression()), !dbg !3103
  ...
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %53, metadata !2369, metadata !DIExpression()), !dbg !3105
  %54 = bitcast %"class.std::basic_ostream"* %53 to i8**, !dbg !3107
  %55 = load i8*, i8** %54, align 8, !dbg !3107, !tbaa !2375
  %56 = getelementptr i8, i8* %55, i64 -24, !dbg !3107
  %57 = bitcast i8* %56 to i64*, !dbg !3107
  %58 = load i64, i64* %57, align 8, !dbg !3107
  %59 = bitcast %"class.std::basic_ostream"* %53 to i8*, !dbg !3107
  %60 = getelementptr inbounds i8, i8* %59, i64 %58, !dbg !3107
  call void @llvm.dbg.value(metadata i8* %60, metadata !2377, metadata !DIExpression()), !dbg !3108
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !3108
  %61 = getelementptr inbounds i8, i8* %60, i64 240, !dbg !3110
  %62 = bitcast i8* %61 to %"class.std::ctype"**, !dbg !3110
  %63 = load %"class.std::ctype"*, %"class.std::ctype"** %62, align 8, !dbg !3110, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %63, metadata !2403, metadata !DIExpression()), !dbg !3111
  %64 = icmp eq %"class.std::ctype"* %63, null, !dbg !3113
...
66:                                               ; preds = %46
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %63, metadata !2421, metadata !DIExpression()), !dbg !3116
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !3116
  %67 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %63, i64 0, i32 8, !dbg !3118
  %68 = load i8, i8* %67, align 8, !dbg !3118, !tbaa !2434
  %69 = icmp eq i8 %68, 0, !dbg !3118
  br i1 %69, label %73, label %70, !dbg !3119

70:                                               ; preds = %66
  %71 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %63, i64 0, i32 9, i64 10, !dbg !3120
  %72 = load i8, i8* %71, align 1, !dbg !3120, !tbaa !2439
  br label %79, !dbg !3121

73:                                               ; preds = %66
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %63), !dbg !3122
  %74 = bitcast %"class.std::ctype"* %63 to i8 (%"class.std::ctype"*, i8)***, !dbg !3123
  %75 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %74, align 8, !dbg !3123, !tbaa !2375
  %76 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %75, i64 6, !dbg !3123
  %77 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %76, align 8, !dbg !3123
  %78 = call noundef signext i8 %77(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %63, i8 noundef signext 10), !dbg !3123
  br label %79, !dbg !3124

79:                                               ; preds = %70, %73
  %80 = phi i8 [ %72, %70 ], [ %78, %73 ], !dbg !3116
  %81 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %53, i8 noundef signext %80), !dbg !3125
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %81, metadata !2353, metadata !DIExpression()), !dbg !3126
  %82 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %81), !dbg !3128
  ...
  %83 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef nonnull getelementptr inbounds ([18 x i8], [18 x i8]* @.str.13, i64 0, i64 0), i64 noundef 17), !dbg !3133
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* @_ZSt4cout, metadata !2285, metadata !DIExpression()), !dbg !3134
  call void @llvm.dbg.value(metadata i8* %9, metadata !2291, metadata !DIExpression()), !dbg !3134
  call void @llvm.dbg.value(metadata i8* %9, metadata !3058, metadata !DIExpression()), !dbg !3136
  %84 = call i64 @strlen(i8* noundef nonnull dereferenceable(1) %9) #18, !dbg !3138
  %85 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef nonnull %9, i64 noundef %84), !dbg !3139
  ...
  %86 = load i8*, i8** bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8**), align 8, !dbg !3144, !tbaa !2375
  %87 = getelementptr i8, i8* %86, i64 -24, !dbg !3144
  %88 = bitcast i8* %87 to i64*, !dbg !3144
  %89 = load i64, i64* %88, align 8, !dbg !3144
  %90 = getelementptr inbounds i8, i8* bitcast (%"class.std::basic_ostream"* @_ZSt4cout to i8*), i64 %89, !dbg !3144
  call void @llvm.dbg.value(metadata i8* %90, metadata !2377, metadata !DIExpression()), !dbg !3145
  call void @llvm.dbg.value(metadata i8 10, metadata !2389, metadata !DIExpression()), !dbg !3145
  %91 = getelementptr inbounds i8, i8* %90, i64 240, !dbg !3147
  %92 = bitcast i8* %91 to %"class.std::ctype"**, !dbg !3147
  %93 = load %"class.std::ctype"*, %"class.std::ctype"** %92, align 8, !dbg !3147, !tbaa !2394
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %93, metadata !2403, metadata !DIExpression()), !dbg !3148
  %94 = icmp eq %"class.std::ctype"* %93, null, !dbg !3150
  br i1 %94, label %95, label %96, !dbg !3151
...
96:                                               ; preds = %79
  call void @llvm.dbg.value(metadata %"class.std::ctype"* %93, metadata !2421, metadata !DIExpression()), !dbg !3153
  call void @llvm.dbg.value(metadata i8 10, metadata !2429, metadata !DIExpression()), !dbg !3153
  %97 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %93, i64 0, i32 8, !dbg !3155
  %98 = load i8, i8* %97, align 8, !dbg !3155, !tbaa !2434
  %99 = icmp eq i8 %98, 0, !dbg !3155
  br i1 %99, label %103, label %100, !dbg !3156

100:                                              ; preds = %96
  %101 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %93, i64 0, i32 9, i64 10, !dbg !3157
  %102 = load i8, i8* %101, align 1, !dbg !3157, !tbaa !2439
  br label %109, !dbg !3158

103:                                              ; preds = %96
  call void @_ZNKSt5ctypeIcE13_M_widen_initEv(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %93), !dbg !3159
  %104 = bitcast %"class.std::ctype"* %93 to i8 (%"class.std::ctype"*, i8)***, !dbg !3160
  %105 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %104, align 8, !dbg !3160, !tbaa !2375
  %106 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %105, i64 6, !dbg !3160
  %107 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %106, align 8, !dbg !3160
  %108 = call noundef signext i8 %107(%"class.std::ctype"* noundef nonnull align 8 dereferenceable(570) %93, i8 noundef signext 10), !dbg !3160
  br label %109, !dbg !3161

109:                                              ; preds = %100, %103
  %110 = phi i8 [ %102, %100 ], [ %108, %103 ], !dbg !3153
  %111 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8 noundef signext %110), !dbg !3162
  call void @llvm.dbg.value(metadata %"class.std::basic_ostream"* %111, metadata !2353, metadata !DIExpression()), !dbg !3163
  %112 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %111), !dbg !3165
  call void @_Z13tick_all_testi(i32 noundef %0), !dbg !3166
  %113 = call i32 @__hipPushCallConfiguration(i64 4294968320, i32 1, i64 4294968320, i32 1, i64 noundef 0, %struct.ihipStream_t* noundef null), !dbg !3167
  %114 = icmp eq i32 %113, 0, !dbg !3167
  br i1 %114, label %115, label %134, !dbg !3168

115:                                              ; preds = %109
  %116 = bitcast %struct.dim3* %3 to i8*, !dbg !3168
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %116), !dbg !3168
  %117 = bitcast %struct.dim3* %4 to i8*, !dbg !3168
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %117), !dbg !3168
  %118 = bitcast i64* %5 to i8*, !dbg !3168
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %118), !dbg !3168
  %119 = bitcast i8** %6 to i8*, !dbg !3168
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %119), !dbg !3168
  %120 = bitcast i8** %7 to i8*, !dbg !3168
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %120), !dbg !3168
  %121 = call i32 @__hipPopCallConfiguration(%struct.dim3* nonnull %3, %struct.dim3* nonnull %4, i64* nonnull %5, i8** nonnull %6), !dbg !3168
  %122 = load i64, i64* %5, align 8, !dbg !3168
  %123 = bitcast i8** %6 to %struct.ihipStream_t**, !dbg !3168
  %124 = load %struct.ihipStream_t*, %struct.ihipStream_t** %123, align 8, !dbg !3168
  %125 = bitcast %struct.dim3* %3 to i64*, !dbg !3168
  %126 = load i64, i64* %125, align 8, !dbg !3168
  %127 = getelementptr inbounds %struct.dim3, %struct.dim3* %3, i64 0, i32 2, !dbg !3168
  %128 = load i32, i32* %127, align 8, !dbg !3168
  %129 = bitcast %struct.dim3* %4 to i64*, !dbg !3168
  %130 = load i64, i64* %129, align 8, !dbg !3168
  %131 = getelementptr inbounds %struct.dim3, %struct.dim3* %4, i64 0, i32 2, !dbg !3168
  %132 = load i32, i32* %131, align 8, !dbg !3168
  %133 = call noundef i32 @hipLaunchKernel(i8* noundef bitcast (void ()** @_Z12dummy_kernelv to i8*), i64 %126, i32 %128, i64 %130, i32 %132, i8** noundef nonnull %7, i64 noundef %122, %struct.ihipStream_t* noundef %124), !dbg !3168
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %116), !dbg !3168
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %117), !dbg !3168
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %118), !dbg !3168
  ...
  br label %134, !dbg !3168

134:                                              ; preds = %115, %109
  call void @llvm.lifetime.end.p0i8(i64 792, i8* nonnull %9) #18, !dbg !3169
  ret i32 0, !dbg !3170
}
